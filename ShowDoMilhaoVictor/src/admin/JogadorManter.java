...
private Integer posicao;  
     ...
     */
    public JogadorManter() throws SQLException {
        initComponents();
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
       Jogador item = new Jogador();
        ...
        {
            JOptionPane.showMessageDialog(rootPane, "Todos campos obrigatorias");
        }
        else
        {
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
         if (txtEmail.getText().isEmpty()==false)
        {
         ...
         if (deucerto==true){
             JOptionPane.showMessageDialog(rootPane, "Excluido com sucessso");
              try {
                  lista = dao.listar();
