...
public class Inicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        silvio.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagem/silvio.jpg"))); // NOI18N
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jPanel2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(silvio, javax.swing.GroupLayout.DEFAULT_SIZE, 261, Short.MAX_VALUE)))
        );
    ...
    private void mnuGerenciarJogadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuGerenciarJogadorActionPerformed
        // TODO add your handling code here:
        JogadorManter tela = null;
        try {
            tela = new JogadorManter();
    ...
    private void mnuListaJogadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuListaJogadorActionPerformed
        // TODO add your handling code here:
        JogadorListar tela = null;
        try {
            tela = new JogadorListar();
        } catch (SQLException ex) {
            Logger.getLogger(Inicio.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void mnuListaPerguntaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuListaPerguntaActionPerformed
        // TODO add your handling code here
        PerguntaListar tela = null;
        try {
            tela = new PerguntaListar();
        } catch (SQLException ex) {
            Logger.getLogger(Inicio.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void silvioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_silvioMouseClicked
        silvio.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagem/silvio.jpg")));
