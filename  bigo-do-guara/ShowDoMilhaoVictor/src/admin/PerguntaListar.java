...
public class PerguntaListar extends javax.swing.JFrame {
    ...
    public PerguntaListar() {
        ...
        item.setEnunciado("Qual o nome do Kariel?");
        item.setA("Kariel");
        item.setB("Renan");
        item.setC("Maydana");
        item.setD("Victor");
        ...
        item = new Pergunta();
        item.setEnunciado("Onde fica o Rio Grande do Sul?");
        item.setA("No Sul.");
        item.setB("No Sudeste");
        item.setC("No Norte");
        item.setD("No Nordeste");
        item.setCerta("A");
        ...
        item = new Pergunta();
        item.setEnunciado("Quem é a presidente do Brasil?");
        item.setA("Renan");
        item.setB("Lucas");
        item.setC("Victor");
        item.setD("Dilma");
